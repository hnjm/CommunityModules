...
namespace Community.UserAccount.UI.Areas.Account.Pages
{
    public class LoginWith2faModel : PageModel
    {
        ...
        public LoginWith2faModel(
            ...
            IGpgAuthenticatorService gpgAuthenticatorService)
        {
        ...
        public async Task<IActionResult> OnPostAsync(bool rememberMe, string returnUrl = null)
        {
            ...
            var result =
                await _signInManager.TwoFactorSignInAsync(_gpgAuthenticatorService.TokenType, authenticatorCode, rememberMe, RememberMachine);
